...
if __name__ == '__main__':
  #Path to the times.txt in KITTI dataset
	ground_time = np.loadtxt('/spslam/kitti-odometry-gray/sequences/05/times.txt')
  
  #Path to the KeyFrameTrajectory.txt file
	# path = sys.argv[1]
	# res_time = np.loadtxt(sys.argv[1])
	res_time = np.loadtxt('/spslam/ORB_SLAM2_copy/KeyFrameTrajectory.txt')  
  #Path to the ground truth file
	ground_data = np.loadtxt('/spslam/kitti-odometry-gray/poses/05.txt')
